package LowLevelDesigns.DesignVendingMachine.VendingStates.Impl;
...
public class DispenseState implements State {
    DispenseState(VendingMachine machine, int codeNumber) throws ItemSoldOutException, ItemNotFoundException {
    ...
    @Override
    public Item dispenseProduct(VendingMachine machine, int codeNumber) throws ItemSoldOutException, ItemNotFoundException {
